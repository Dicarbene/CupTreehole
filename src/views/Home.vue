...
/*
    ...
    <svg
      class="fill-secondary col-start-1 row-start-1 h-full w-full"
      width="1600"
      height="1000"
...
<template>
  <main class="hero from-primary to-secondary bg-gradient-to-br text-primary-content min-h-screen h-auto">
